...
public class RfidSensorMsg implements com.roslib.ros.Msg {
    ...
    public int serialize(byte[] outbuffer, int start) {
        ...
        offset += 4;
        int bits_signalCutoff = Float.floatToRawIntBits(signalCutoff);
        outbuffer[offset + 0] = (byte)((bits_signalCutoff >> (8 * 0)) & 0xFF);
        outbuffer[offset + 1] = (byte)((bits_signalCutoff >> (8 * 1)) & 0xFF);
        outbuffer[offset + 2] = (byte)((bits_signalCutoff >> (8 * 2)) & 0xFF);
        outbuffer[offset + 3] = (byte)((bits_signalCutoff >> (8 * 3)) & 0xFF);
        offset += 4;
    ...
    public int deserialize(byte[] inbuffer, int start) {
        ...
        offset += 4;
        int bits_signalCutoff = 0;
        bits_signalCutoff |= (int)((inbuffer[offset + 0] & 0xFF) << (8 * 0));
        bits_signalCutoff |= (int)((inbuffer[offset + 1] & 0xFF) << (8 * 1));
        bits_signalCutoff |= (int)((inbuffer[offset + 2] & 0xFF) << (8 * 2));
        bits_signalCutoff |= (int)((inbuffer[offset + 3] & 0xFF) << (8 * 3));
        this.signalCutoff = Float.intBitsToFloat(bits_signalCutoff);
        offset += 4;
    ...
    public java.lang.String getType(){ return "stdr_msgs/RfidSensorMsg"; }
    public java.lang.String getMD5(){ return "3a6106dfe9b9c2d30a153b1539b2632e"; }
