...
public static final java.lang.String GETROUTEPLAN = "geographic_msgs/GetRoutePlan";

public class GetRoutePlanRequest implements com.roslib.ros.Msg {
    private long __id__;
    public com.roslib.uuid_msgs.UniqueID network;
    public com.roslib.uuid_msgs.UniqueID start;
    public com.roslib.uuid_msgs.UniqueID goal;

    public GetRoutePlanRequest() {
        this.network = new com.roslib.uuid_msgs.UniqueID();
        this.start = new com.roslib.uuid_msgs.UniqueID();
        this.goal = new com.roslib.uuid_msgs.UniqueID();
        this.__id__ = 0;
    }
    ...
    public java.lang.String getType() { return GETROUTEPLAN; }
    public java.lang.String getMD5(){ return "ba158f79f4ed4771e50143e56ff78905"; }
    public long getID() { return this.__id__; }
    public void setID(long id) { this.__id__ = id; }
}

public class GetRoutePlanResponse implements com.roslib.ros.Msg {
    private long __id__;
    public boolean success;
    public java.lang.String status;
    public com.roslib.geographic_msgs.RoutePath plan;

    public GetRoutePlanResponse() {
        this.success = false;
        this.status = "";
        this.plan = new com.roslib.geographic_msgs.RoutePath();
        this.__id__ = 0;
    }
    ...
    public java.lang.String getType() { return GETROUTEPLAN; }
    public java.lang.String getMD5(){ return "45192ffe523f10c7dd1e09de81d58b69"; }
    public long getID() { return this.__id__; }
    public void setID(long id) { this.__id__ = id; }
}
