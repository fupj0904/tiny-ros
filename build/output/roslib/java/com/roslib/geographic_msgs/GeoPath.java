...
public class GeoPath implements com.roslib.ros.Msg {
    public com.roslib.std_msgs.Header header;
    public com.roslib.geographic_msgs.GeoPoseStamped[] poses;
    ...
    public int deserialize(byte[] inbuffer, int start) {
        ...
        offset += 4;
        if(length_poses > 0) {
            this.poses = new com.roslib.geographic_msgs.GeoPoseStamped[length_poses];
        }
        for (int i = 0; i < length_poses; i++){
    ...
    public java.lang.String getType(){ return "geographic_msgs/GeoPath"; }
    public java.lang.String getMD5(){ return "8468c8f0de07b106069e728c0f76d888"; }
