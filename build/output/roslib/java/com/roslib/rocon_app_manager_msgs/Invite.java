...
public static final java.lang.String INVITE = "rocon_app_manager_msgs/Invite";

public class InviteRequest implements com.roslib.ros.Msg {
    private long __id__;
    public java.lang.String remote_target_name;
    ...
    public int serialize(byte[] outbuffer, int start) {
        ...
        offset += 4;
        int length_remote_target_name = this.remote_target_name.getBytes().length;
        outbuffer[offset + 0] = (byte)((length_remote_target_name >> (8 * 0)) & 0xFF);
        outbuffer[offset + 1] = (byte)((length_remote_target_name >> (8 * 1)) & 0xFF);
        outbuffer[offset + 2] = (byte)((length_remote_target_name >> (8 * 2)) & 0xFF);
        outbuffer[offset + 3] = (byte)((length_remote_target_name >> (8 * 3)) & 0xFF);
        offset += 4;
        for (int k=0; k<length_remote_target_name; k++) {
            outbuffer[offset + k] = (byte)((this.remote_target_name.getBytes())[k] & 0xFF);
        }
    ...
    public int deserialize(byte[] inbuffer, int start) {
        ...
        offset += 4;
        int length_remote_target_name = (int)((inbuffer[offset + 0] & 0xFF) << (8 * 0));
        length_remote_target_name |= (int)((inbuffer[offset + 1] & 0xFF) << (8 * 1));
        length_remote_target_name |= (int)((inbuffer[offset + 2] & 0xFF) << (8 * 2));
        length_remote_target_name |= (int)((inbuffer[offset + 3] & 0xFF) << (8 * 3));
        offset += 4;
        byte[] bytes_remote_target_name = new byte[length_remote_target_name];
        for(int k= 0; k< length_remote_target_name; k++){
            bytes_remote_target_name[k] = (byte)(inbuffer[k + offset] & 0xFF);
        }
        this.remote_target_name = new java.lang.String(bytes_remote_target_name);
        offset += length_remote_target_name;
    ...
    public int serializedLength() {
        ...
        int length_remote_target_name = this.remote_target_name.getBytes().length;
        length += 4;
        length += length_remote_target_name;
        int length_application_namespace = this.application_namespace.getBytes().length;
        length += 4;
    ...
    public java.lang.String getType() { return INVITE; }
    public java.lang.String getMD5(){ return "e33c0834337fe991c826abae88add94f"; }
    public long getID() { return this.__id__; }
    public void setID(long id) { this.__id__ = id; }
}

public class InviteResponse implements com.roslib.ros.Msg {
    private long __id__;
    ...
    public java.lang.String getType() { return INVITE; }
    public java.lang.String getMD5(){ return "4cc9e51d26c198c725e3d970f18d3829"; }
    public long getID() { return this.__id__; }
    public void setID(long id) { this.__id__ = id; }
}
