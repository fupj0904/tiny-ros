...
public class BoolParameter implements com.roslib.ros.Msg {
    ...
    public int serialize(byte[] outbuffer, int start) {
        ...
        offset += length_name;
        outbuffer[offset] = (byte)((value ? 0x01 : 0x00) & 0xFF);
        offset += 1;
        return offset;
    }
    ...
    public int deserialize(byte[] inbuffer, int start) {
        ...
        offset += length_name;
        this.value = (boolean)((inbuffer[offset] & 0xFF) != 0 ? true : false);
        offset += 1;
        return offset;
    }
    ...
    public java.lang.String getType(){ return "dynamic_reconfigure/BoolParameter"; }
    public java.lang.String getMD5(){ return "746a060b87182b428a5c6ee319891c6a"; }
