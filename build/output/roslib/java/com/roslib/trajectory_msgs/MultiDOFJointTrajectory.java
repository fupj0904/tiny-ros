...
public class MultiDOFJointTrajectory implements com.roslib.ros.Msg {
    public com.roslib.std_msgs.Header header;
    public java.lang.String[] joint_names;
    public com.roslib.trajectory_msgs.MultiDOFJointTrajectoryPoint[] points;
    ...
    public int deserialize(byte[] inbuffer, int start) {
        ...
        offset += 4;
        if(length_points > 0) {
            this.points = new com.roslib.trajectory_msgs.MultiDOFJointTrajectoryPoint[length_points];
        }
        for (int i = 0; i < length_points; i++){
    ...
    public java.lang.String getType(){ return "trajectory_msgs/MultiDOFJointTrajectory"; }
    public java.lang.String getMD5(){ return "19f97d4cdcae9d0ef55126c1495f6c91"; }
