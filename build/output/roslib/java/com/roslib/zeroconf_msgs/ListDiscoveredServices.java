...
public class ListDiscoveredServices {

public static final java.lang.String LISTDISCOVEREDSERVICES = "zeroconf_msgs/ListDiscoveredServices";

public class ListDiscoveredServicesRequest implements com.roslib.ros.Msg {
    private long __id__;
    ...
    public java.lang.String getType() { return LISTDISCOVEREDSERVICES; }
    public java.lang.String getMD5(){ return "3efefb2332060cd029d0f1deb443a9d6"; }
    public long getID() { return this.__id__; }
    public void setID(long id) { this.__id__ = id; }
}

public class ListDiscoveredServicesResponse implements com.roslib.ros.Msg {
    private long __id__;
    public com.roslib.zeroconf_msgs.DiscoveredService[] services;
    ...
    public int deserialize(byte[] inbuffer, int start) {
        ...
        if(length_services > 0) {
            this.services = new com.roslib.zeroconf_msgs.DiscoveredService[length_services];
        }
        for (int i = 0; i < length_services; i++){
    ...
    public java.lang.String getType() { return LISTDISCOVEREDSERVICES; }
    public java.lang.String getMD5(){ return "20b63d34c58ab874d4b719c1f0934b3f"; }
    public long getID() { return this.__id__; }
    public void setID(long id) { this.__id__ = id; }
}
