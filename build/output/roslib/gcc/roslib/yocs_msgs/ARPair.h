...
namespace yocs_msgs
{
  ...
  class ARPair : public ros::Msg
  {
    ...
    {
      int length = 0;
      length += sizeof(this->left_id);
      length += sizeof(this->right_id);
      length += sizeof(this->baseline);
      length += sizeof(this->target_offset);
      uint32_t length_target_frame = strlen(this->target_frame);
      length += 4;
    ...
    const char * getMD5(){ return "b62211da078ffe8d7d6bc29aa7484206"; }
