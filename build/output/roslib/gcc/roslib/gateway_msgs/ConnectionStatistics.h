...
namespace gateway_msgs
{
  ...
  class ConnectionStatistics : public ros::Msg
  {
    ...
    {
      int length = 0;
      length += sizeof(this->gateway_available);
      length += sizeof(this->time_since_last_seen);
      length += sizeof(this->ping_latency_min);
      length += sizeof(this->ping_latency_max);
      length += sizeof(this->ping_latency_avg);
      length += sizeof(this->ping_latency_mdev);
      length += sizeof(this->network_info_available);
      length += sizeof(this->network_type);
      length += sizeof(this->wireless_bitrate);
      length += sizeof(this->wireless_link_quality);
      length += sizeof(this->wireless_signal_level);
      length += sizeof(this->wireless_noise_level);
      return length;
    }

    const char * getType(){ return "gateway_msgs/ConnectionStatistics"; }
    const char * getMD5(){ return "5a094df81e613f8907d969d1ae54536f"; }
