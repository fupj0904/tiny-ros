#ifndef _ROS_tinyros_msgs_TopicInfo_h
#define _ROS_tinyros_msgs_TopicInfo_h
...
namespace tinyros_msgs
{
  ...
  class TopicInfo : public ros::Msg
  {
    ...
    const char * getType(){ return "tinyros_msgs/TopicInfo"; }
    const char * getMD5(){ return "a67d0ceb3e53d38be7128f6a74ba77ca"; }
