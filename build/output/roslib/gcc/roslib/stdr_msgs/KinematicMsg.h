...
namespace stdr_msgs
{
  ...
  class KinematicMsg : public ros::Msg
  {
    ...
    virtual int serializedLength() const
    {
      ...
      length += 4;
      length += length_type;
      length += sizeof(this->a_ux_ux);
      length += sizeof(this->a_ux_uy);
      length += sizeof(this->a_ux_w);
      length += sizeof(this->a_uy_ux);
      length += sizeof(this->a_uy_uy);
      length += sizeof(this->a_uy_w);
      length += sizeof(this->a_w_ux);
      length += sizeof(this->a_w_uy);
      length += sizeof(this->a_w_w);
      length += sizeof(this->a_g_ux);
      length += sizeof(this->a_g_uy);
      length += sizeof(this->a_g_w);
      return length;
    }

    const char * getType(){ return "stdr_msgs/KinematicMsg"; }
    const char * getMD5(){ return "cf0b9abaed86b18d8a763aca389d5103"; }
