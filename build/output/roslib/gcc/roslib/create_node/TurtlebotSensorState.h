...
namespace create_node
{
  ...
  class TurtlebotSensorState : public ros::Msg
  {
    ...
    virtual int serializedLength() const
    {
      ...
      length += sizeof(this->bumps_wheeldrops);
      length += sizeof(this->wall);
      length += sizeof(this->cliff_left);
      length += sizeof(this->cliff_front_left);
      length += sizeof(this->cliff_front_right);
      length += sizeof(this->cliff_right);
      length += sizeof(this->virtual_wall);
      length += sizeof(this->motor_overcurrents);
      length += sizeof(this->dirt_detector_left);
      length += sizeof(this->dirt_detector_right);
      length += sizeof(this->remote_opcode);
      length += sizeof(this->buttons);
      length += sizeof(this->distance);
      length += sizeof(this->angle);
      length += sizeof(this->charging_state);
      ...
      length += sizeof(this->wall_signal);
      length += sizeof(this->cliff_left_signal);
      length += sizeof(this->cliff_front_left_signal);
      length += sizeof(this->cliff_front_right_signal);
      length += sizeof(this->cliff_right_signal);
      length += sizeof(this->user_digital_outputs);
      length += sizeof(this->user_digital_inputs);
      length += sizeof(this->user_analog_input);
      length += sizeof(this->charging_sources_available);
      length += sizeof(this->oi_mode);
      length += sizeof(this->song_number);
      length += sizeof(this->song_playing);
      length += sizeof(this->number_of_stream_packets);
      length += sizeof(this->requested_velocity);
      length += sizeof(this->requested_radius);
      length += sizeof(this->requested_right_velocity);
      length += sizeof(this->requested_left_velocity);
      return length;
    }

    const char * getType(){ return "create_node/TurtlebotSensorState"; }
    const char * getMD5(){ return "044e0f367b4b23b46a75a54341c1b962"; }
