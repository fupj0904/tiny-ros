...
static const char TAKEPANORAMA[] = "turtlebot_msgs/TakePanorama";
  ...
  class TakePanoramaRequest : public ros::Msg
  {
    ...
    virtual int serializedLength() const
    {
      ...
      length += sizeof(this->pano_angle);
      length += sizeof(this->snap_interval);
      length += sizeof(this->rot_vel);
      return length;
    }

    const char * getType(){ return TAKEPANORAMA; }
    const char * getMD5(){ return "ba7a4ec9789671ab2188353e3b116fa7"; }
  ...
  class TakePanoramaResponse : public ros::Msg
  {
    ...
    const char * getType(){ return TAKEPANORAMA; }
    const char * getMD5(){ return "a9f91f3015c52b7c2a6bc80426bdcb5d"; }
    const uint32_t getID(){ return this->__id__; }
    void setID(uint32_t id){ this->__id__ = id; }
