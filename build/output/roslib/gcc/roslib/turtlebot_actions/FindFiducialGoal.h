...
namespace turtlebot_actions
{
  ...
  class FindFiducialGoal : public ros::Msg
  {
    ...
    virtual int serializedLength() const
    {
      ...
      length += sizeof(this->pattern_width);
      length += sizeof(this->pattern_height);
      length += sizeof(this->pattern_size);
      length += sizeof(this->pattern_type);
      return length;
    }

    const char * getType(){ return "turtlebot_actions/FindFiducialGoal"; }
    const char * getMD5(){ return "7956e2ad4c2c2c9a3a37a9eb830dd5b3"; }
